...
class DrawerViewController: UIViewController {
    var cellModels: [WLSettingsCellModels] = {
        let setThemeCell = WLSettingsCellModels(titleName: "主题", canExpand: true)
        let userInfoCell = WLSettingsCellModels(titleName: "个人信息", canExpand: true)
        let advanceCell = WLSettingsCellModels(titleName: "高级", canExpand: true)
    ...
    var advanceCellModel = ["高级": [WLSettingsCellModels(titleName: "开始计时"),
                                    WLSettingsCellModels(titleName: "附近店铺"),
                                    WLSettingsCellModels(titleName: "关于App")]]
